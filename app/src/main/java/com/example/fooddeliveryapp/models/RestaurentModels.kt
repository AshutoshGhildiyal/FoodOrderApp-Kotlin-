...
data class RestaurentModels(val name: String?, val address: String?, val delivery_charge: String?,
    ...
    companion object CREATOR : Parcelable.Creator<RestaurentModels> {
        override fun createFromParcel(parcel: Parcel): RestaurentModels {
            return RestaurentModels(parcel)
        }

        override fun newArray(size: Int): Array<RestaurentModels?> {
